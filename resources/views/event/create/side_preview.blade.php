...
<div v-show="eventTemplate == 4 && !extraPreviewBool"
     class="text-center rounded-lg bg-gray-50 w-7/12 h-vh-90 fixed left-3.5/10 shadow-2xl grid grid-cols-12">
    <div v-show="bannerBool" class="col-span-5 flex flex-col justify-center px-2 rounded-xl h-3/4 my-auto ml-12">
        <img class="templateBanner w-full">
    </div>
    <div v-show="!bannerBool"
         class="col-span-5 flex flex-col justify-center px-2 bg-light-50 rounded-xl h-3/4 my-auto ml-12">
        <div class="text-5xl text-dark-300 font-skuy-primary">Banner</div>
        <span class="fa fa-image text-dark-300 text-5xl"></span>
    </div>
    ...
    <div class="col-span-7 flex flex-col justify-end font-sans text-right pr-8 pl-14 py-24">
        ...
        <div class="relative h-full w-full">
            ...
            <div v-show="!logoBool"
                 class="text-center rounded-lg bg-white absolute top-0 right-0 w-24 h-24 p-1 shadow-2xl flex flex-col justify-center">
                <div class="text-2xl text-dark-300 font-skuy-primary">Logo</div>
                <span class="fa fa-image text-dark-300 text-2xl"></span>
            </div>
        </div>
        ...
        <div v-show='eventTitle == ""' v-bind:style="{color: titleColor}"
             class="text-4xl font-semibold mb-2 break-words text-right">Judul
        </div>
        <div class="text-4xl font-semibold mb-2 break-words text-right" v-bind:style="{color: titleColor}">
            @{{ eventTitle }}</div>
        <span v-show='eventDesc == ""' v-bind:style="{color: descColor}"
              class="text-md mb-2 break-words text-right float-right">Deskripsikan event disini.</span>
        <span class="text-md mb-2 break-words text-right float-right" v-bind:style="{color: descColor}">@{{ eventDesc }}</span>
        <span class="text-md mb-2 flex justify-end clear-both" v-bind:style="{color: dateColor}">
...
<div v-show="eventTemplate == 5 && !extraPreviewBool"
    ...
    <div v-show="!bannerBool"
        class="row-span-3 flex flex-col justify-center bg-light-50 h-9/10">
        <div class="text-5xl text-dark-300 font-skuy-primary">Banner</div>
        <span class="fa fa-image text-dark-300 text-5xl"></span>
    </div>
    <div class="row-span-3 flex flex-col justify-start font-sans text-left px-12 mt-8 w-full overflow-hidden">
    ...
    <div v-show="logoBool" class="rounded-lg bg-white absolute top-12 right-16 w-24 p-1 shadow-2xl">
        <img class="templateLogo rounded-lg">
    </div>
    <div v-show="!logoBool"
        class="rounded-lg bg-white absolute top-12 right-16 w-24 h-24 p-1 shadow-2xl flex flex-col justify-center">
        <div class="text-2xl text-dark-300 font-skuy-primary">Logo</div>
        <span class="fa fa-image text-dark-300 text-2xl"></span>
    </div>
    <div v-show="extraBool" v-bind:style="{'background-color': extraButtonColor, color:extraTextColor}"
...
<!-- note extra template 3 -->
<div v-show="extraTemplate == 3 && extraPreviewBool"
    class="text-center rounded-lg bg-gray-50 w-7/12 h-vh-90 fixed left-3.5/10 shadow-2xl grid justify-items-center items-center"
    v-bind:class="{ 'grid-cols-1': extraComponentCount == 1, 'grid-cols-2': extraComponentCount == 2, 'grid-cols-3': extraComponentCount == 3, 'grid-cols-4': extraComponentCount == 4, 'grid-cols-5': extraComponentCount == 5}">
    <div class="text-dark-300 text-center font-medium text-5xl absolute left-0 right-0 top-8 mx-auto break-words">
        @{{ extraMainHeading }}</div>
    <div v-show="extraComponentCount >=1" class="font-skuy-primary-sub bg-gray-200 p-4 rounded-2xl">
        <div v-show="!extraImage1Bool" class="w-40 h-40 bg-gray rounded-full flex flex-col justify-center bg-gray-100">
            <div class="text-2xl text-dark-300 font-skuy-primary">Image 1</div>
            <span class="fa fa-image text-dark-300 text-2xl"></span>
        </div>
        <div v-show="extraImage1Bool" class="w-40 h-40 bg-white rounded-full flex flex-col justify-center">
    ...
    <div v-show="extraComponentCount >=2" class="font-skuy-primary-sub bg-gray-200 p-4 rounded-2xl">
        <div v-show="!extraImage2Bool" class="w-40 h-40 bg-gray rounded-full flex flex-col justify-center bg-gray-100">
            <div class="text-2xl text-dark-300 font-skuy-primary">Image 2</div>
            <span class="fa fa-image text-dark-300 text-2xl"></span>
        </div>
        <div v-show="extraImage2Bool" class="w-40 h-40 bg-white rounded-full flex flex-col justify-center">
    ...
    <div v-show="extraComponentCount >=3" class="font-skuy-primary-sub bg-gray-200 p-4 rounded-2xl">
        <div v-show="!extraImage3Bool" class="w-40 h-40 bg-gray rounded-full flex flex-col justify-center bg-gray-100">
            <div class="text-2xl text-dark-300 font-skuy-primary">Image 3</div>
            <span class="fa fa-image text-dark-300 text-2xl"></span>
        </div>
        <div v-show="extraImage3Bool" class="w-40 h-40 bg-white rounded-full flex flex-col justify-center">
    ...
    <div v-show="extraComponentCount >=4" class="font-skuy-primary-sub bg-gray-200 p-4 rounded-2xl">
        <div v-show="!extraImage4Bool" class="w-40 h-40 bg-gray rounded-full flex flex-col justify-center bg-gray-100">
            <div class="text-2xl text-dark-300 font-skuy-primary">Image 4</div>
            <span class="fa fa-image text-dark-300 text-2xl"></span>
        </div>
        <div v-show="extraImage4Bool" class="w-40 h-40 bg-white rounded-full flex flex-col justify-center">
    ...
    <div v-show="extraComponentCount >=5" class="font-skuy-primary-sub bg-gray-200 p-4 rounded-2xl">
        <div v-show="!extraImage5Bool" class="w-40 h-40 bg-gray rounded-full flex flex-col justify-center bg-gray-100">
            <div class="text-2xl text-dark-300 font-skuy-primary">Image 5</div>
            <span class="fa fa-image text-dark-300 text-2xl"></span>
        </div>
        <div v-show="extraImage5Bool" class="w-40 h-40 bg-white rounded-full flex flex-col justify-center">
