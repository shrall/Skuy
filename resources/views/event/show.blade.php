...
<div id="vue-app">
        ...
        @if ($event->template == 2)
            <div v-show="eventTemplate == 2"
                class="text-center bg-gray-50 w-full h-screen shadow-2xl grid grid-cols-12">
                <div
                ...
                @if ($event->banner != null)
                    <div
                        class="col-span-12 flex flex-col justify-center bg-light-50 h-full overflow-hidden relative">
                        <img src="{{ asset('events/banner/' . $event->banner) }}"
                            class="templateBanner w-full">
