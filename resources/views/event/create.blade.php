                ...
                <div class="w-full bg-light-300 flex flex-col shadow-2xl">
                    <div class="px-6 py-8">
                        ...
                        <div class="flex flex-row text-dark-200 justify-evenly mb-4">
                            ...
                            <span class="font-skuy-primary-sub text-xl font-bold">Template @{{ eventTemplate }}</span>
                        ...
                        <div id="inputLogo"
                            ...
                            <form class="flex flex-col content-center text-center ">
                                <input type="file" id="logoElem" accept="image/*" onchange="handleLogoFiles(this.files)"
                                    class="hidden">
                                <label for="logoElem"
                        ...
                        <div id="inputBanner"
                            class="border-dashed border-2 border-gray-400 rounded-3xl w-full bg-light-200 my-4 py-12">
                            <form class="flex flex-col content-center text-center ">
                                <input type="file" id="bannerElem" accept="image/*"
                        ...
                        <input v-model="eventTitle" type="text" class="inputArea mb-4"
                            placeholder="Your Event Name, max 100 characters." maxlength="100">
                        ...
                        <textarea v-model="eventDesc" class="inputArea mb-4 resize-none"
                        ...
                        <div class="flex flex-row items-center mb-2">
                            ...
                            <input id="inputEmail" @keyup="changeEmail" type="email" class="inputArea"
                                placeholder="example@skuy.com">
                        </div>
                        <div class="flex flex-row items-center mb-2">
                            <span class="fab fa-fw fa-instagram text-dark-300 text-3xl mr-2"></span>
                            <input id="inputInstagram" @keyup="changeInstagram" type="text" class="inputArea"
                                placeholder="Instagram Username">
                        </div>
                        <div class="flex flex-row items-center mb-4">
                            <span class="fab fa-fw fa-whatsapp text-dark-300 text-3xl mr-2"></span>
                            <input id="inputWhatsapp" @keyup="changeWhatsapp" type="text" class="inputArea"
                        ...
                        <div v-show="registerBool">
                            ...
                            <input v-model="registerText" type="text" class="inputArea mb-4"
                                placeholder="Max 20 Characters." maxlength="20">
                            <div class="skuyHeader text-2xl mb-2">Button Color</div>
                            <input v-model="registerButtonColor" data-jscolor="{}" class="inputArea mb-2">
                            <div class="skuyHeader text-2xl mb-2">Text Color</div>
                            <input v-model="registerTextColor" data-jscolor="{}" class="inputArea mb-2">
                        </div>
                        <div class="skuyHeader text-3xl my-4">Settings</div>
                        <div class="skuyHeader text-2xl mb-2">Custom Link</div>
                        <input v-model="customLink" type="text" class="inputArea mb-2" placeholder="Max 50 Characters."
                            maxlength="50">
                        <div class="skuyHeader text-2xl mb-2">Title Color</div>
                        <input v-model="titleColor" data-jscolor="{}" class="inputArea mb-2">
                        <div class="skuyHeader text-2xl mb-2">Description Color</div>
                        <input v-model="descColor" data-jscolor="{}" class="inputArea mb-2">
                        <div class="skuyHeader text-2xl mb-2">Date Color</div>
                        <input v-model="dateColor" data-jscolor="{}" class="inputArea mb-2">
                        <div class="skuyHeader text-2xl mb-2">Contacts Color</div>
                        <input v-model="contactsColor" data-jscolor="{}" class="inputArea mb-2">
                    </div>
                    <div
            ...
            <div v-show="preview && previewMobile" class="w-full h-screen bg-light-50 px-16 py-8 text-center">
                ...
                <div v-show="eventTemplate == 2"
                    ...
                    <div v-show="bannerBool" class="absolute flex flex-col justify-center overflow-hidden h-full">
                        <img class="templateBanner my-auto">
                        <div v-show="bannerBool" class="bg-black rounded-xl h-full w-full absolute opacity-20">
                        </div>
                    </div>
                    <div v-show="logoBool"
                        class="rounded-lg bg-white absolute top-12 left-52 right-0 w-24 p-1 shadow-2xl mx-auto">
