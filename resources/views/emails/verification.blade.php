...
<center>
    <a target="_blank" href="mailto:eventskuy@gmail.com">
        <svg class="contactIcons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#1f1f1f">
            <path
    ...
    <a target="_blank" href="https://www.instagram.com/event.skuy/">
        <svg class="contactIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="#1f1f1f">
            <path
